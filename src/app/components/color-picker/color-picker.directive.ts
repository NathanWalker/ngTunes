...
const styleUrls: string[] = ['./app/components/color-picker/color-picker.css'];
const templateUrl: string = './app/components/color-picker/color-picker.html';
...
export class ColorPickerDirective implements OnInit {
    ...
    @Input('cpPosition') cpPosition: string = 'left';
